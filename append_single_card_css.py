# Script to append Single Card CSS redesign to App.css
import os

# Read the redesign CSS
with open(r'c:\Users\Harsh\Desktop\travel\AI4\single_card_redesign.css', 'r', encoding='utf-8') as f:
    redesign_css = f.read()
...
print("✅ Successfully appended Single Card CSS redesign to App.css!")
